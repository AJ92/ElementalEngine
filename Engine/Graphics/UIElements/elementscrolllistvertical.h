#ifndef ELEMENTSCROLLLISTVERTICAL_H
#define ELEMENTSCROLLLISTVERTICAL_H


#include "UIElements/element.h"
#include <QTimer>

class ElementScrollListVertical : public Element
{
    Q_OBJECT
public:
    explicit ElementScrollListVertical();
    ...
    void set_content_rect_height(int height);
...
#endif // ELEMENTSCROLLLISTVERTICAL_H
