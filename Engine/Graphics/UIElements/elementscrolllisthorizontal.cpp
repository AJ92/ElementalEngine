#include "elementscrolllisthorizontal.h"


ElementScrollListHorizontal::ElementScrollListHorizontal():
    Element(),
    screen_size_x(1),
    screen_size_y(1),
    space_to_top(5),
...
void ElementScrollListHorizontal::add_element(Element* e){
    element_list.append(e);
    e->update_screen_size(screen_size_x, screen_size_y);
    arrange_my_elements();
}

bool ElementScrollListHorizontal::remove_element(Element* e){
...
//override:
void ElementScrollListHorizontal::set_pos_space(float x_pos, float y_pos, float z_pos){
    Element::set_pos_space(x_pos,y_pos,z_pos);
    //update_my_elements_pos_space();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_x_pos_space(float x_pos){
    Element::set_x_pos_space(x_pos);
    //update_my_elements_pos_space();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_y_pos_space(float y_pos){
    Element::set_y_pos_space(y_pos);
    //update_my_elements_pos_space();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_z_pos_space(float z_pos){
    Element::set_z_pos_space(z_pos);
    //update_my_elements_pos_space();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_pos_px(int x_pos, int y_pos, int z_pos){
    Element::set_pos_px(x_pos, y_pos, z_pos);
    //update_my_elements_pos_px();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_x_pos_px(int x_pos){
    Element::set_x_pos_px(x_pos);
    //update_my_elements_pos_px();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_y_pos_px(int y_pos){
    Element::set_y_pos_px(y_pos);
    //update_my_elements_pos_px();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_z_pos_px(int z_pos){
    Element::set_z_pos_px(z_pos);
    //update_my_elements_pos_px();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_scale_space(float x_scale, float y_scale, float z_scale){
    Element::set_scale_space(x_scale,y_scale,z_scale);
    //update_size_space();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_x_scale_space(float x_scale){
    Element::set_x_scale_space(x_scale);
    //update_size_space();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_y_scale_space(float y_scale){
    Element::set_y_scale_space(y_scale);
    //update_size_space();
    arrange_my_elements();
}

void ElementScrollListHorizontal::set_z_scale_space(float z_scale){
...
void ElementScrollListHorizontal::set_content_rect_width(int width){
    this->content_rect_width = width;
}


void ElementScrollListHorizontal::update_my_elements_pos_space(){
...
void ElementScrollListHorizontal::update_my_elements_pos_px(){
...
void ElementScrollListHorizontal::arrange_my_elements(){
    int total_width = 0;
    int total_height = 0;
    for(int i = 0; i < element_list.length(); i++){
        int px_width_offset = 0;
        total_width += element_list[i]->x_size_px() + space_between_elements;
        if(total_height < element_list[i]->y_size_px()){
            total_height = element_list[i]->y_size_px();
        }
        for(int j = 0; j < i; j++){
            px_width_offset += element_list[j]->x_size_px() + space_between_elements;
        }
    ...
    total_width -= space_between_elements;
    ...
    content_rect_height =  content_height + space_to_top + space_to_bottom;
}
...
bool ElementScrollListHorizontal::touch(QMouseEvent* e){
    if(is_enabled()){
        //qDebug("elementscrolllisthorizontal touch checking...");
...
int ElementScrollListHorizontal::abs(int x){
    return (x > 0) ? x : -x;
}
...
void ElementScrollListHorizontal::scroll_back(){
    if(scroll){
        int scroll_factor = 8;
        ...
        scroll = false;
        if(abs(offset_x) >  abs(content_rect_width - content_width) || offset_x < 0){
...
void ElementScrollListHorizontal::update_screen_size(int size_x, int size_y){
...
void ElementScrollListHorizontal::check_mouse_move(QMouseEvent* e){
...
void ElementScrollListHorizontal::check_mouse_press(QMouseEvent* e){
    if(touch(e)){
...
void ElementScrollListHorizontal::check_mouse_release(QMouseEvent* e){
    if(pressed){
...
void ElementScrollListHorizontal::resize_elements(int new_screen_size_x, int new_screen_size_y){
    for(int i = 0; i < element_list.length(); i++){
